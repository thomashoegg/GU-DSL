...
#pragma once
#ifndef __REMOVECOMMUNICATIONDETECTEDEVENT_H__
#define __REMOVECOMMUNICATIONDETECTEDEVENT_H__
...
namespace Core
{
	namespace Mediation
	{
		namespace Events
		{
			 ...
			 *
			 */
			class CORE_API RemoveCommunicationDetectedEvent : public Core::Mediation::Event
			{
				DECLARE_EVENT
			public:
				/**
				 ...
				 */
				RemoveCommunicationDetectedEvent(Core::Communication::CommunicationDataPtr communicationData);

				/**
				 * \brief destructor.
				 *
				 */
				virtual ~RemoveCommunicationDetectedEvent();
