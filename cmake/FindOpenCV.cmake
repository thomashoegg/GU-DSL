...
if(EXISTS "$ENV{OpenCV_DIR}")
		...
		message(STATUS "CV Envvar exists.")
        #When its possible to use the Config script use it.
        if(EXISTS "$ENV{OpenCV_DIR}/build/OpenCVConfig.cmake")

				set(OpenCV_FOUND_TMP true)
				message(STATUS "CV Config found")
		
                ## Include the standard CMake script
                include("$ENV{OpenCV_DIR}/build/OpenCVConfig.cmake")
				
                ## Search for a specific version
                set(CVLIB_SUFFIX "${OpenCV_VERSION_MAJOR}${OpenCV_VERSION_MINOR}${OpenCV_VERSION_PATCH}")
				
				set(OPENCV_LIB_COMPONENTS ${OpenCV_LIBS})
        ...
        #Otherwise it try to guess it.
        else(EXISTS "$ENV{OpenCV_DIR}/build/OpenCVConfig.cmake")
				...
				foreach(__CVLIB ${OPENCV_LIB_COMPONENTS})
						...
						#message(STATUS "CV Lib Name: ${__CVLIB}")
						
						find_library(OpenCV_${__CVLIB}_LIBRARY_DEBUG NAMES "${__CVLIB}${CVLIB_SUFFIX}d" "lib${__CVLIB}${CVLIB_SUFFIX}d" PATHS "$ENV{OpenCV_DIR}/staticlib" "$ENV{OpenCV_DIR}/lib/Debug" NO_DEFAULT_PATH)
						find_library(OpenCV_${__CVLIB}_LIBRARY_RELEASE NAMES "${__CVLIB}${CVLIB_SUFFIX}" "lib${__CVLIB}${CVLIB_SUFFIX}" PATHS "$ENV{OpenCV_DIR}/staticlib" "$ENV{OpenCV_DIR}/lib/Release" NO_DEFAULT_PATH)
		...
		endif(EXISTS "$ENV{OpenCV_DIR}/build/OpenCVConfig.cmake")


else(EXISTS "$ENV{OpenCV_DIR}")
		#message(STATUS "CV envvar not existing")
...
option(OpenCV_BACKWARD_COMPA "Add some variable to make this script compatible with the other version of FindOpenCV.cmake" false)
        ...
        find_path(OpenCV_INCLUDE_DIRS "cv.h" PATHS "$ENV{OpenCV_DIR}" PATH_SUFFIXES "include" "include/opencv" "build/include/opencv" DOC "Include directory") 
        find_path(OpenCV_INCLUDE_DIR "cv.h" PATHS "$ENV{OpenCV_DIR}" PATH_SUFFIXES "include" "include/opencv" "build/include/opencv" DOC "Include directory")
		
		set(OpenCV2_INCLUDE_DIR $ENV{OpenCV_DIR}/build/include/opencv2)
...
##====================================================
## Make sure ReleaseWithDebugInfo uses Release dlls
##----------------------------------------------------
